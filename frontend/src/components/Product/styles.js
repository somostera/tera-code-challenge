...
`
export const BookTitleShelf = styled.h2`
  font-size: 2rem;
  font-weight: lighter;
` 
export const BookAuthorShelf = styled.span`
  display: block;
  font-size: 1.2rem;
` 
export const BookCategoryShelf = styled.span`
  font-size: 1.2rem;
` 
...
`
export const BookTitle = styled(BookTitleShelf)`
  font-size: 3rem;
  font-weight: 400;
  margin-bottom: 1rem;
  width: 100%;
...
`
const ProductDetailInfoBase = styled(BookAuthorShelf) `
  width: 100%;
  font-size: 1.4rem;
...
`
export const BookAuthor = styled(ProductDetailInfoBase)`
`
export const BookCategory = styled(ProductDetailInfoBase)`
`
export const IsBookOnStock = styled(ProductDetailInfoBase) `
  margin-bottom: 1rem;
  margin-top: .7rem;
`
export const BookDescription = styled.p`
  ...
  grid-area: paragraph;
`
export const BookImgContainer = styled.div.attrs(props => ({
...
`
export const BookImg = styled(CustomImg)`
  width: 100%;
  /* height: auto; */
  object-fit: contain;
  max-width: 300px;
`
export const OutOfStockText = styled.figcaption.attrs({
